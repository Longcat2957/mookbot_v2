...
export function SeriesSummary({
	...
	return (
		<div
			className={`card surface-base shadow-sm ${state.seriesCompleted ? "border border-success" : ""}`}
		>
			<div className="card-body p-4 gap-3">
				...
				<details className="collapse collapse-arrow surface-quiet-soft">
					<summary className="collapse-title text-sm font-medium py-2 min-h-0 px-3">라인업 보기</summary>
